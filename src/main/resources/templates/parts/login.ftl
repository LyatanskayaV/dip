...
<form action="${path}" method="post">
    ...
    title-shadow: 0 0 5px #ffffff, 0 0 10px #ffffff, 0 0 20px #ffffff,
    ...
    0 0 10px #000000, 0 0 150px #000000;" class="col-form-label">Ім'я користувача:</label>
        <div class="col-sm-6">
            <input type="title" name="username" class="form-control" placeholder="Ім'я користувача" />
        </div>
    </div>
    <div class="form-group row">
        <label style="font-size: 20px;  color: #ffffff;
    ...
    <#if !isRegisterForm>
           <a style="title-align:left; color: black;width: 180px; height: 40px; background-color: #faaeae; display: inline-block;
